import fs from 'fs';
import type { ResponseLike } from 'dbahn-stations/internal/to-file';
import { toFile } from 'dbahn-stations/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('dbahn-stations/core/uploads');
    await expect(
