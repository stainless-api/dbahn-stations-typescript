...
export { ClientOptions } from 'dbahn-stations';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/dbahn-stations',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the dbahn-stations MCP server. You will use Code Mode to help the user perform
